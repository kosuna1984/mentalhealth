...
sum(is.na(mental_set$self_employed)) #[1] 18
...
#It looks like it is "work_interfere". (If you have a mental health condition, do you feel that it interferes with your work?)
